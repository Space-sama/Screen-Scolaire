...
<center><div class="jumbotron jumbotron-fluid">
    <b><h3 id="head" >Les Conférences</b></h3>
    <b><span id='head2'>Moments de Dialogue & Partage des Idées</span></b>
    </div></center>
                  <?php
    ...
    $req=$bdd->query("SELECT *
        ...
        WHERE (SELECT (CA.LIBELLE='Activites' AND A.Sous_Categorie='Conferences') 
