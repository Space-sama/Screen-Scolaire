...
<br /><br /><br />
   <center><div class="jumbotron jumbotron-fluid">
    <b><h3 style ="font-family: fangsong; font-size: 25px;" id="head" >Visites des entreprises</b></h3>
    <b><span style ="font-family: fangsong; font-size: 22px; color: white;">Connaissances Techniques & Scientifiques</span></b>
    </div></center>
    <?php
      include("Connexion.php");
      $req=$bdd->query("SELECT *
      FROM CATEGORIE_ANNONCE CA JOIN ANNONCE A ON  CA.ID_CATEGORIE = A.ID_CATEGORIE
      WHERE (SELECT CA.LIBELLE='Activites' AND A.Sous_Categorie='Visites' 
    ...
    JOIN IMAGE I ON A.ID_ANNONCE = I.ID_ANNONCE
    WHERE CA.LIBELLE='Activites' AND A.Sous_Categorie='Visites' AND '$ID_ANNONCE'=A.ID_ANNONCE AND A.ARCHIVE=0 
                    ...
                    <div class="carousel-inner row w-100 mx-auto" role="listbox" style="max-width:1000px; max-height:1000px !important;">
                        ...
                        <div class="carousel-item active">
                            <img class="img-fluid mx-auto d-block" src="data:image/jpeg;base64,<?php echo $OneImage ?>" alt="<?php $data['TITRE'] ?>" width="700px" height="800px">
                              ...
                              # Display each image for each announcement
