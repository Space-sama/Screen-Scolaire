<?php
  ...
  WHERE(SELECT (CA.LIBELLE='Administratif' AND f.NOM_FILIERE='Ingenierie' AND f.FORMATION='Continue' AND g.Classe='$GIC')
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/cssbox.Less">
    <link rel="icon" type="image/png" href="../assets/img/n.png" />
    <link rel="stylesheet" href="../assets/css/colors.css"/>
    <script src="code.jquery.com/jquery.js"></script>
		
    <title>Annonces Administratifs pour la fillière Ingénierie</title>
  </head>
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    ...
    <a id='pagi_previous' class="page-link" href="Ing_Administratif.php?page=<?php
        if($precedent <= 0){
          echo $precedent = 1;
    ...
    <?php 
      ...
      ?>
        <li class="page-item"><a id='pagi_btn' class="page-link" href="Ing_Administratif.php?page=<?=$i; ?>"><?= $i ?></a></li>  
      <?php endfor;?>
      <?php
    ?>
    ...
    <li class="page-item">
      <a  id='pagi_next'  class="page-link" href="Ing_Administratif.php?page=<?=$suivant; ?>" aria-label="Next">
