...
WHERE(SELECT (CA.LIBELLE='Entreprises' AND f.NOM_FILIERE='Ingenierie' AND f.FORMATION='Continue' AND g.Classe='$GIC')
...
<html lang="en">
  <head>
    ...
    <title>Annonces d'Entreprises pour Ingénierie</title>
  </head>
...
<div class="container" id='container'>
  ...
  <ul class="pagination">
    ...
    <a id='pagi_previous' class="page-link" href="Ing_Entreprises.php?page=<?php
        if($precedent <= 0){
          echo $precedent = 1;
    ...
    <?php 
      ...
      ?>
       <li class="page-item"><a id='pagi_btn' class="page-link" href="Ing_Entreprises.php?page=<?=$i; ?>"><?= $i ?></a></li>  
      <?php endfor;?>
      <?php
    ?>
    ...
    <li class="page-item">
      <a id='pagi_next' class="page-link" href="Ing_Entreprises.php?page=<?=$suivant; ?>" aria-label="Next">
