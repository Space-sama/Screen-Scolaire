...
WHERE(SELECT (CA.LIBELLE='Activites' AND f.NOM_FILIERE='Ingenierie' AND f.FORMATION='Continue' AND g.Classe='$GIC')
...
<?php header('Content-Type: text/html;charset=UTF-8'); ?>
  ...
  <title>Annonces des Activités pour Ingénierie</title>
</head>
...
<div class="card text" id='cardText'>   
    ...
    <span id='exp'>Date d'éxpération le : </span><b><?php echo $DATE_EXP ?></b>
  </div>
...
<br />
  ...
  <ul class="pagination">
    ...
    <a id='pagi_previous' class="page-link" href="Ing_Activites.php?page=<?php
        if($precedent <= 0){
          echo $precedent = 1;
    ...
    <?php 
      ...
      ?>
       <li class="page-item"><a id='pagi_btn' class="page-link" href="Ing_Activites.php?page=<?=$i; ?>"><?= $i ?></a></li>  
      <?php endfor;?>
      <?php
    ?>
    ...
    <li class="page-item">
      <a id='pagi_next' class="page-link" href="Ing_Activites.php?page=<?=$suivant; ?>" aria-label="Next">
