...
WHERE(SELECT (f.NOM_FILIERE='Ingenierie' AND f.FORMATION='Continue' AND g.Classe= '$GIC')
...
<html lang="en">
  <head>
    ...
    <title>Annonces pour la filière Ingénierie</title>
...
<?php
      ...
      include('../includes/ing-header.php');
?>
...
<div class="container" id='container'>
    ...
    <div class="card-footer text-muted" style="background-color:#ffcdb0;">
    ...
    <li class="page-item">
      <a id='pagi_next' class="page-link" href="index.php?page=<?=$suivant; ?>" aria-label="Next">
        ...
        <span class="sr-only">Next</span>
          ...
          <div class="col-md-4">
                    <br>
                      <div  class="card border-light mb-3" class="list-group" id='allmenu'>
                      <h4 id='allmenu' class="card-header"><i style="color:white;" class="fa fa-bars"></i> <span id='voirAussi'>Voir aussi</span></h4>
                      <a href="/PFA/ingenieur/Ing_Administratif.php" role="button" id='allmenu' class="list-group-item list-group-item-action"> <i class="fa fa-folder-open" aria-hidden="true"></i> <span id='titreMenu'>Administratif</span></a>
                      <a href="/PFA/ingenieur/Ing_Activites.php" role="button" id='allmenu' class="list-group-item list-group-item-action"> <i class="fa fa-plus-square" aria-hidden="true"></i> <span id='titreMenu'>Activités</span></a>
                      <a href="/PFA/ingenieur/Ing_Pédagogique.php" role="button" id='allmenu' class="list-group-item list-group-item-action"><i class="fa fa-archive" aria-hidden="true"></i> <span id='titreMenu'>Pédagogique</span></a>
                      <a href="/PFA/ingenieur/Ing_Entreprises.php" role="button" id='allmenu' class="list-group-item list-group-item-action"><i class="fa fa-building" aria-hidden="true"></i> <span id='titreMenu'>Entreprises</span></a>
      ...
      while($data=$req->fetch())
      {
          ...
          $pre = $data['Prenom'];
      ?>
  <center><div class="list-group-item list-group-item-action" id='allmenu'>
