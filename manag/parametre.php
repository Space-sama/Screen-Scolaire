...
header("Location: /PFA/manag/parametre.php?id=$onlyOneStudent");
...
<nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
  <a class="navbar-brand" href="/PFA/manag/"><img src="img/isga.png "style="width:70px;display:block;margin-right:auto;margin-left: auto;"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="/PFA/manag/"> 
    ...
    <a href="/PFA/manag/index.php" class="btn btn-outline-primary my-2 my-sm-0"><i class="fa fa-home" aria-hidden="true"></i> Retour à la page d'acceuil</a>
    </form>
        ...
        <div class="container">
            <div class="row text-white">
                ...
                <p  class="card-header" class="h5"><i class="fa fa-cogs" aria-hidden="true"></i>
                        ...
                        <p style="color: red; font-size: 20px; font-family: 'OpenSans-italic';" id="msg"><strong></strong></p>
                    <div class="px-2">
                        <form action="" method="post" id="form" class="justify-content-center">
                            <div class="form-group">
                        <label name="error"></label>
                                <input type="text" id="user" name="user" class="form-control" value="<?php echo "$USER"?>" placeholder="Nouveau nom">
                            </div>
                            <div class="form-group">
                            <i class="fa fa-key" aria-hidden="true"></i>  Changer le mot de passe </p>
                                <input type="text" id="pwd" name="p1" class="form-control" value="<?php echo "$PWD"?>"   placeholder="Nouveau mot de pass"><br />
                                <input type="text" id="pwd1" name="p2" class="form-control" value="<?php echo "$PWD"?>"  placeholder="Retapez le mot de pass">
                            </div>
...
<?php 
    ...
    if($res){ 
      ...
      echo '<script>window.location.href ="/PFA/manag/";</script>';
