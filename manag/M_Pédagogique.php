...
WHERE(SELECT (CA.LIBELLE='Pedagogique' AND f.NOM_FILIERE='Management' AND f.FORMATION='Continue' AND g.Classe='$GMC')
...
<html>
  ...
  <meta charset="utf-8">
    ...
    <title>Annonces Pédagogiques pour la fillière Management</title>
  </head>
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    ...
    <a id='pagi_previous' class="page-link" href="M_Pédagogique.php?page=<?php
        if($precedent <= 0){
          echo $precedent = 1;
    ...
    <?php 
      ...
      ?>
       <li class="page-item"><a id='pagi_btn' class="page-link" href="M_Pédagogique.php?page=<?=$i; ?>"><?= $i ?></a></li>  
      <?php endfor;?>
      <?php
    ?>
    ...
    <li class="page-item">
      <a id='pagi_next' class="page-link" href="M_Pédagogique.php?page=<?=$suivant; ?>" aria-label="Next">
        ...
        <span class="sr-only">Next</span>
                ...
                <!--les Annonces-->
                      ...
                      <a href="/PFA/manag/M_Administratif.php" role="button" id='allmenu' class="list-group-item list-group-item-action"> <i class="fa fa-folder-open" aria-hidden="true"></i> <span id='titreMenu'>Administratif</a>
