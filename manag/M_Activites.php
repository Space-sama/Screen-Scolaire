...
WHERE(SELECT (CA.LIBELLE='Activites' AND f.NOM_FILIERE='Management' AND f.FORMATION='Continue' AND g.Classe='$GMC')
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
  ...
  <title>Annonces des Activités pour Management</title>
</head>
...
<br />
  ...
  <ul class="pagination">
    ...
    <a id='pagi_previous' class="page-link" href="M_Activites.php?page=<?php
        if($precedent <= 0){
          echo $precedent = 1;
    ...
    <?php 
      ...
      ?>
       <li class="page-item"><a id='pagi_btn' class="page-link" href="M_Activites.php?page=<?=$i; ?>"><?= $i ?></a></li>  
      <?php endfor;?>
      <?php
    ?>
    ...
    <li class="page-item">
      <a id='pagi_next' class="page-link" href="M_Activites.php?page=<?=$suivant; ?>" aria-label="Next">
