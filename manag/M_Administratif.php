...
WHERE(SELECT (CA.LIBELLE='Administratif' AND f.NOM_FILIERE='Management' AND f.FORMATION='Continue' AND g.Classe='$GMC')
...
<html lang="en">
  <head>
    ...
    <title>Annonces Administratifs pour la fillière Management</title>
  </head>
...
<?php 
  ...
  <?php
    ...
    FROM CATEGORIE_ANNONCE CA JOIN ANNONCE A ON  CA.ID_CATEGORIE = A.ID_CATEGORIE 
                ...
                <div id="carouselExample<?php echo  $ID_ANNONCE ?>" class="carousel slide" data-ride="carousel" data-interval="3000000">
                    ...
                    <div class="carousel-inner row w-100 mx-auto" role="listbox" style="max-width:1000px; max-height:700px !important;">
                        ...
                        <div class="carousel-item active">
                            <img class="img-fluid mx-auto d-block" src="data:image/jpeg;base64,<?php echo $OneImage ?>" alt="<?php $data['TITRE'] ?>" width="1000px" height="360px"  >
                        </div>
                              <?php
                        ...
                        <img class="img-fluid mx-auto d-block" src="data:image/jpeg;base64,<?php echo $img ?>" width="1000px" height="360px" alt="<?php $data['TITRE'] ?>">
                        </div>
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    ...
    <a id='pagi_previous' class="page-link" href="M_Administratif.php?page=<?php
        if($precedent <= 0){
          echo $precedent = 1;
    ...
    <?php 
      ...
      ?>
       <li class="page-item"><a id='pagi_btn' class="page-link" href="M_Administratif.php?page=<?=$i; ?>"><?= $i ?></a></li>  
      <?php endfor;?>
      <?php
    ?>
    ...
    <li class="page-item">
      <a id='pagi_next' class="page-link" href="M_Administratif.php?page=<?=$suivant; ?>" aria-label="Next">
     ...
     <!--ANNONCE-->
                      ...
                      <a href="/PFA/manag/M_Activites.php" role="button" id='allmenu' class="list-group-item list-group-item-action"> <i class="fa fa-plus-square" aria-hidden="true"></i> <span id='titreMenu'> Activités</a>
                      <a href="/PFA/manag/M_Pédagogique.php" role="button" id='allmenu' class="list-group-item list-group-item-action"><i class="fa fa-archive" aria-hidden="true"></i> <span id='titreMenu'> Pédagogique</a>
                      <a href="/PFA/manag/M_Entreprises.php" role="button" id='allmenu' class="list-group-item list-group-item-action"><i class="fa fa-building" aria-hidden="true"></i> <span id='titreMenu'> Entreprises</a>
...
?>      
    ...
    <br />
                 <div class="card border-light mb-3" style="max-width: 50rem;">
                    ...
                    <p class="card-text"> 
                      <iframe name="InlineFrame1" id="InlineFrame1" style="width:200px;height:180px; text-align: center;" src="https://www.mathieuweb.fr/calendrier/calendrier-des-semaines.php?nb_mois=1&nb_mois_ligne=4&mois=0&an=0&langue=fr&texte_color=F5F5F5&week_color=FFFFFF&week_end_color=FFFFFF&police_color=453413&sel=true" scrolling="no" frameborder="0" allowtransparency="true"></iframe></p>
                    </div>
                </div>
           </div>
      </div>  
