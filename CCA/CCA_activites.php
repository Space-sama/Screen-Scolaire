...
WHERE(SELECT (CA.LIBELLE='Activites' AND f.NOM_FILIERE='Management' AND f.FORMATION='Cca' AND g.Classe='$GMCC')
...
<head>
  ...
  <title>Annonces des Activités pour CCA</title>
</head>
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    ...
    <a id='pagi_previous' class="page-link" href="CCA_activites.php?page=<?php
        if($precedent <= 0){
          echo $precedent = 1;
    ...
    <?php 
      ...
      ?>
       <li class="page-item"><a id='pagi_btn' class="page-link" href="CCA_activites.php?page=<?=$i; ?>"><?= $i ?></a></li>  
      <?php endfor;?>
      <?php
    ?>
    ...
    <li class="page-item">
      <a id='pagi_next' class="page-link" href="CCA_activites.php?page=<?=$suivant; ?>" aria-label="Next">
...
<footer class="w3-container w3-grey">
  ...
  <div class="row">
              <div class="col-md-4 footer-brand animated fadeInLeft">
                  <h2 style="text-align:center;"> <img src="../assets/img/n.png" style="width:100px; text-align:center;"></h2>
  <?php
