...
header("Location: /PFA/CCA/parametre.php?id=$onlyOneStudent");
...
<nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
  <a class="navbar-brand" href="/PFA/CCA/"><img src="img/isga.png "style="width:70px;display:block;margin-right:auto;margin-left: auto;"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <a href="/PFA/CCA/" class="btn btn-outline-primary my-2 my-sm-0"><i class="fa fa-home" aria-hidden="true"></i> Retour à la page d'acceuil</a>
    </form>
...
<?php 
    ...
    if($res){ 
      ...
      echo '<script>window.location.href ="/PFA/CCA/";</script>';
    }
  else 
