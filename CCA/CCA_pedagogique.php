...
WHERE(SELECT (CA.LIBELLE='Pedagogique' AND f.NOM_FILIERE='Management' AND f.FORMATION='Cca' AND g.Classe='$GMCC')
...
<html>
  ...
  <meta charset="utf-8">
    ...
    <title>Annonces Pédagogiques pour CCA</title>
  </head>
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    ...
    <a id='pagi_previous' class="page-link" href="CCA_pedagogique.php?page=<?php
        if($precedent <= 0){
          echo $precedent = 1;
    ...
    <?php 
      ...
      ?>
       <li class="page-item"><a id='pagi_btn' class="page-link" href="CCA_pedagogique.php?page=<?=$i; ?>"><?= $i ?></a></li>  
      <?php endfor;?>
      <?php
    ?>
    ...
    <li class="page-item">
      <a id='pagi_next' class="page-link" href="CCA_pedagogique.php?page=<?=$suivant; ?>" aria-label="Next">
