...
WHERE(SELECT (f.NOM_FILIERE='Management' AND f.FORMATION='Cca' AND g.Classe='$GMCC')
...
<html lang="en">
  <head>
    ...
    <title>Annonces pour la filière CCA</title>
    ...
    <li class="page-item">
      <a id='pagi_next' class="page-link" href="index.php?page=<?=$suivant; ?>" aria-label="Next">
        ...
        <span class="sr-only">Next</span>
                ...
                <a href="/PFA/CCA/CCA_entreprise.php" role="button" id='allmenu' class="list-group-item list-group-item-action"><i class="fa fa-building" aria-hidden="true"></i> <span id='titreMenu'>Entreprises</span></a>
