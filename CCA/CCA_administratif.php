...
$GMCC =$_SESSION["GROUPE_MANAG_CCA"];
  ...
  WHERE(SELECT (CA.LIBELLE='Administratif' AND f.NOM_FILIERE='Management' AND f.FORMATION='Cca' AND g.Classe='$GMCC')
...
<html lang="en">
  <head>
    ...
    <title>Annonces Administratifs pour  CCA</title>
  </head>
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    ...
    <a id='pagi_previous' class="page-link" href="CCA_administratif.php?page=<?php
        if($precedent <= 0){
          echo $precedent = 1;
    ...
    <?php 
      ...
      ?>
       <li class="page-item"><a id='pagi_btn' class="page-link" href="CCA_administratif.php?page=<?=$i; ?>"><?= $i ?></a></li>  
      <?php endfor;?>
      <?php
    ?>
    ...
    <li class="page-item">
      <a id='pagi_next' class="page-link" href="CCA_administratif.php?page=<?=$suivant; ?>" aria-label="Next">
