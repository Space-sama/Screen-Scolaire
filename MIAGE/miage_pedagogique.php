...
WHERE(SELECT (CA.LIBELLE='Pedagogique' AND f.NOM_FILIERE='Ingenierie' AND f.FORMATION='Miage' AND g.Classe='$GIM')
...
<html>
  <head>
    ...
    <title>Annonces Pédagogiques pour  MIAGE</title>
  </head>
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    <li class="text-center">
      <a id='pagi_previous' class="page-link" href="miage_pedagogique.php?page=<?php
        if($precedent <= 0){
          echo $precedent = 1;
    ...
    <?php 
      ...
      ?>
       <li class="page-item"><a id='pagi_btn' class="page-link" href="miage_pedagogique.php?page=<?=$i; ?>"><?= $i ?></a></li>  
      <?php endfor;?>
      <?php
    ?>
    ...
    <li class="page-item">
      <a id='pagi_next' class="page-link" href="miage_pedagogique.php?page=<?=$suivant; ?>" aria-label="Next">
