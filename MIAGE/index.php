...
else if(!key_exists('PRESENT_MIAGE', $_SESSION)){ // breaking access for other fil
...
WHERE(SELECT (f.NOM_FILIERE='Ingenierie' AND f.FORMATION='Miage' AND g.Classe='$GIM')
...
<html lang="en">
  <head>
    ...
    <title>Annonces pour la filière MIAGE</title>
...
<?php
      ...
      include('../includes/miage-header.php');
?>
...
<?php 
 ...
 <?php
    ...
    JOIN  filiere f ON f.ID_FILIERE = g.ID_FILIERE
    WHERE(SELECT (f.NOM_FILIERE='Ingenierie' AND f.FORMATION='Miage' AND g.Classe='$GIM')
    WHERE '$ID_ANNONCE' = I.ID_ANNONCE AND A.ARCHIVE=0  AND A.Date_Exp > A.DATE) ORDER BY  myDate");
        ...
        <span class="sr-only">Next</span>
                ...
                <!--les Annonces-->
                  ...
                  <h4 id='allmenu' class="card-header"><i style="color:white;" class="fa fa-bars"></i> <span id='voirAussi'>Voir aussi</span></h4>
                      <a href="/PFA/MIAGE/miage_administratif.php" id='allmenu' role="button" class="list-group-item list-group-item-action"> <i class="fa fa-folder-open" aria-hidden="true"></i> <span id='titreMenu'>Administratif</span></a>
                      <a href="/PFA/MIAGE/miage_activites.php" id='allmenu' role="button" class="list-group-item list-group-item-action"> <i class="fa fa-plus-square" aria-hidden="true"></i> <span id='titreMenu'> Activités</span></a>
                      <a href="/PFA/MIAGE/miage_pedagogique.php" id='allmenu' role="button" class="list-group-item list-group-item-action"><i class="fa fa-archive" aria-hidden="true"></i> <span id='titreMenu'> Pédagogique</span></a>
                      <a href="/PFA/MIAGE/miage_entreprise.php" role="button" id='allmenu' class="list-group-item list-group-item-action"><i class="fa fa-building" aria-hidden="true"></i> <span id='titreMenu'> Entreprises</span></a>
      <?php
