...
WHERE(SELECT (CA.LIBELLE='Entreprises' AND f.NOM_FILIERE='Ingenierie' AND f.FORMATION='Miage' AND g.Classe='$GIM')
...
<html lang="en">
  <head>
    ...
    <title>Annonces d'Entreprises pour MIAGE</title>
  </head>
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    ...
    <a id='pagi_previous' class="page-link" href="miage_entreprise.php?page=<?php
        if($precedent <= 0){
          echo $precedent = 1;
    ...
    <?php 
      ...
      ?>
       <li class="page-item"><a id='pagi_btn' class="page-link" href="miage_entreprise.php?page=<?=$i; ?>"><?= $i ?></a></li>  
      <?php endfor;?>
      <?php
    ?>
    ...
    <li class="page-item">
      <a id='pagi_next' class="page-link" href="miage_entreprise.php?page=<?=$suivant; ?>" aria-label="Next">
